...
roll.onclick=function ()
{
	...
	if((tokenA1==tokenA2)&&((tokenA1!="")&&(tokenA2!=""))&&(tokenA1!=null))
	{
	...
	if((tokenB1==tokenB2)&&((tokenB1!="")&&(tokenB2!=""))&&(tokenB1!=null))
	{
	...
	if(tokenA1==tokenB1 && tokenA1!="" && tokenA1!=null)
	{
		if(eat1==1)
		{
	...
	if(tokenA1==tokenB2 && tokenA1!="" && tokenA1!=null)
	{
		if(eat2==1)
		{
			if(tokenB.innerHTML=="<center>0B</center>")
	...
	if(tokenA2==tokenB1 && tokenA2!="" && tokenA2!=null)
	{
		if(eat3==1)
		{
			if(tokenB.innerHTML=="<center>0B</center>")
	...
	if(tokenA2==tokenB2 && tokenA2!="" && tokenA2!=null)
	{
		if(eat4==1)
		{
			if(tokenB.innerHTML=="<center>0B</center>")
